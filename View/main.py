...
class GraphicalView(object):
    ...
    def render_record(self):
        ...
        for i in range(PlayerNum):
            ...
            pg.draw.rect(self.screen, Color_White, (270+200*i, 600-height, 120, height))
            pg.draw.rect(self.screen, (255, 250, 200), (270+200*i, 550-height, 120, 50))
            pg.draw.rect(self.screen, color, (280+200*i, 600-height, 10, height))
            pg.draw.rect(self.screen, color, (370+200*i, 600-height, 10, height))
            self.screen.blit(self.player_photo[rank[i].index], (270+200*i,600))
            score_surface = self.smallfont.render(str(score), True, color)
            self.blit_at_center(score_surface, (330+200*i, 575-height))
